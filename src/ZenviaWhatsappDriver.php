...
class ZenviaWhatsappDriver extends HttpDriver
{
    ...
    const API_URL = 'https://api.zenvia.com/v2';
    const FILE_API_URL = 'https://api.zenvia.com/v2';
    ...
    public function getUser(IncomingMessage $matchingMessage)
    {
        ...
        if ($response->getStatusCode() !== 200) {
            throw new ZenviaWhatsappException('Error retrieving user info: '.$responseData['description']);
        }
    ...
    private function postWithExceptionHandling(
        ...
        throw new ZenviaWhatsappConnectionException($message);
    }
}
